document.addEventListener('DOMContentLoaded', function() {
    ...
    selectElements.forEach(function(selectElement) {
        selectElement.addEventListener('change', function(event) {
            ...
            document.getElementById('switch_add_profile').innerHTML = '<p>Enter a name for the new profile: <input type=\"text\" name=\"profile\" id=\"new_profile_name\" /><input type=\"hidden\" name=\"page\" value=\"quickplayground_builder\" /> <button type=\"submit\">Add</button></p>';
            return;
            }
