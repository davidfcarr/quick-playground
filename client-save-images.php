...
$images = $wpdb->get_results($wpdb->prepare("SELECT * FROM %i WHERE post_type='attachment' AND post_status='inherit' AND ID > %d ORDER BY ID DESC",$wpdb->posts,$qckply_top_ids['posts']));
if(!empty($images)) {
